...
1. **Visit** [smartspend.tech](https://smartspend.tech)
2. **Create an account** or continue as a guest
3. **Add** your payment profiles and loyalty cards
4. **Search** for a retailer and enter your spend amount
5. **Get** the best recommended combination for maximum rewards
...
> ⚠️ **Disclaimer**: Estimates only. Actual rewards may vary based on your provider, reward tier, eligibility, caps, exclusions, and programme terms. SmartSpend does not provide financial advice.
