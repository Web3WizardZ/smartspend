...
function getAmountBand(amount) {
  if (amount <= 100) return 'R0–R100';
  if (amount <= 250) return 'R101–R250';
  if (amount <= 500) return 'R251–R500';
  if (amount <= 1000) return 'R501–R1,000';
  if (amount <= 2500) return 'R1,001–R2,500';
  return 'R2,500+';
}
